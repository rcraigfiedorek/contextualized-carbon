...
taylor_jet_fact = SingleVarFactTemplate(
    ...
    message=(
        'This is equal to the emissions that would be generated by Taylor Swift flying her private jet around the '
...
new_england_forest_fact = SingleVarFactTemplate(
    ...
    message='It would take %s of New England forest to absorb this amount of carbon per year from the atmosphere.'
)
